...
#FlyCapture2 SDK
find_path(FlyCapture2_INCLUDE_DIR NAMES FlyCapture2.h
        PATHS $ENV{FlyCapture2_ROOT_DIR}/include
        PATH_SUFFIXES flycapture)
find_library(FlyCapture2_LIBRARY NAMES FlyCapture2_v100 FlyCapture2 flycapture2 flycapture
        PATHS ${FlyCapture2_LIBDIR})

# Triclops SDK
find_path(Triclops_INCLUDE_DIR NAMES triclops.h
        PATHS $ENV{Triclops_ROOT_DIR}/include
        PATH_SUFFIXES triclops triclops4)
find_library(Triclops_LIBRARY NAMES triclops4 libtriclops4.so.4
        PATHS ${Triclops_LIBDIR})
find_library(FlyCaptureBridge_LIBRARY NAMES flycapture2bridge4 libflycapture2bridge4.so.4
        PATHS ${Triclops_LIBDIR})
